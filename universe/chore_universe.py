...
def get_universe():
    ...
    Explanation
        ...
        - 실물자산
            ...
            - BCI (5%)
    """
    universe_dict = {'name': ['삼성전자', 'NAVER', 'KODEX 미국S&P500선물(H)', 'TIGER 미국채10년선물', 'KODEX 미국채울트라30년선물(H)', 'Vanguard Total World Stock Index'],
                     'country': ['korea', 'korea', 'korea', 'korea', 'korea', 'abroad'],
                     'category': ['주식', '주식', '주식', '채권', '채권', '채권'],
                     'percent': [0., 0., 0., 0., 0., 0.],
                     'code': []}
